...
export const presets = withDefaults([
  ...
  },
  {
    ...
    subforms: [
      ...
      domain('Domain coloring', 'sqrt(z) + c'),
      domain('Domain coloring', 'cos(z) + c'),
      domain('Domain coloring', 'sin(z) + c'),
      domain('Domain coloring', 'tan(z) + c'),
      domain('Domain coloring', 'acos(z) + c'),
      domain('Domain coloring', 'asin(z) + c'),
      domain('Domain coloring', 'atan(z) + c'),
      domain('Domain coloring', 'cosh(z) + c'),
      domain('Domain coloring', 'sinh(z) + c'),
      domain('Domain coloring', 'tanh(z) + c'),
      domain('Domain coloring', 'acosh(z) + c'),
      domain('Domain coloring', 'asinh(z) + c'),
      domain('Domain coloring', 'atanh(z) + c'),
      domain('Domain coloring', 'log(z) + c'),
      domain('Domain coloring', 'exp(z) + c'),
      domain('Domain coloring', 'abs(z) + c'),
      domain('Domain coloring', 'beta(z, c)', { point: cx(2) }),
      domain('Domain coloring', "beta'(z, c)", { point: cx(2) }),
      domain('Domain coloring', 'gamma(z) + c'),
      domain('Domain coloring', "gamma'(z) + c"),
      domain('Domain coloring', 'zeta(z) + c'),
      domain('Domain coloring', "zeta'(z) + c"),
      domain('Domain coloring', 'psi(z) + c'),
      // domain('Domain coloring', 'phi(z) + c'),
      domain('Domain coloring', 'arg(z) + c'),
      domain('Domain coloring', 'norm(z) + c'),
      domain('Domain coloring', 'tania(z) + c'),
      domain('Domain coloring', 'atania(z) + c'),
      domain('Domain coloring', 'doya(z) + c'),
      domain('Domain coloring', 'filog(z) + c'),
