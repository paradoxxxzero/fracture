 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(T,D){var A=T.length;T.push(D);e:for(;0<A;){var K=A-1>>>1,re=T[K];if(0<i(re,D))T[K]=D,T[A]=re,A=K;else break e}}function t(T){return T.length===0?null:T[0]}function r(T){if(T.length===0)return null;var D=T[0],A=T.pop();if(A!==D){T[0]=A;e:for(var K=0,re=T.length,Cr=re>>>1;K<Cr;){var Mn=2*(K+1)-1,Yi=T[Mn],An=Mn+1,Nr=T[An];if(0>i(Yi,A))An<re&&0>i(Nr,Yi)?(T[K]=Nr,T[An]=A,K=An):(T[K]=Yi,T[Mn]=A,K=Mn);else if(An<re&&0>i(Nr,A))T[K]=Nr,T[An]=A,K=An;else break e}}return D}function i(T,D){var A=T.sortIndex-D.sortIndex;return A!==0?A:T.id-D.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var o=Date,u=o.now();e.unstable_now=function(){return o.now()-u}}var s=[],a=[],v=1,m=null,p=3,g=!1,y=!1,z=!1,P=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(T){for(var D=t(a);D!==null;){if(D.callback===null)r(a);else if(D.startTime<=T)r(a),D.sortIndex=D.expirationTime,n(s,D);else break;D=t(a)}}function x(T){if(z=!1,d(T),!y)if(t(s)!==null)y=!0,Zi(N);else{var D=t(a);D!==null&&qi(x,D.startTime-T)}}function N(T,D){y=!1,z&&(z=!1,f(E),E=-1),g=!0;var A=p;try{for(d(D),m=t(s);m!==null&&(!(m.expirationTime>D)||T&&!Ue());){var K=m.callback;if(typeof K=="function"){m.callback=null,p=m.priorityLevel;var re=K(m.expirationTime<=D);D=e.unstable_now(),typeof re=="function"?m.callback=re:m===t(s)&&r(s),d(D)}else r(s);m=t(s)}if(m!==null)var Cr=!0;else{var Mn=t(a);Mn!==null&&qi(x,Mn.startTime-D),Cr=!1}return Cr}finally{m=null,p=A,g=!1}}var L=!1,j=null,E=-1,W=5,M=-1;function Ue(){return!(e.unstable_now()-M<W)}function Tt(){if(j!==null){var T=e.unstable_now();M=T;var D=!0;try{D=j(!0,T)}finally{D?Lt():(L=!1,j=null)}}else L=!1}var Lt;if(typeof c=="function")Lt=function(){c(Tt)};else if(typeof MessageChannel<"u"){var Ss=new MessageChannel,c0=Ss.port2;Ss.port1.onmessage=Tt,Lt=function(){c0.postMessage(null)}}else Lt=function(){P(Tt,0)};function Zi(T){j=T,L||(L=!0,Lt())}function qi(T,D){E=P(function(){T(e.unstable_now())},D)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(T){T.callback=null},e.unstable_continueExecution=function(){y||g||(y=!0,Zi(N))},e.unstable_forceFrameRate=function(T){0>T||125<T?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<T?Math.floor(1e3/T):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return t(s)},e.unstable_next=function(T){switch(p){case 1:case 2:case 3:var D=3;break;default:D=p}var A=p;p=D;try{return T()}finally{p=A}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(T,D){switch(T){case 1:case 2:case 3:case 4:case 5:break;default:T=3}var A=p;p=T;try{return D()}finally{p=A}},e.unstable_scheduleCallback=function(T,D,A){var K=e.unstable_now();switch(typeof A=="object"&&A!==null?(A=A.delay,A=typeof A=="number"&&0<A?K+A:K):A=K,T){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=A+re,T={id:v++,callback:D,priorityLevel:T,startTime:A,expirationTime:re,sortIndex:-1},A>K?(T.sortIndex=A,n(a,T),t(s)===null&&T===t(a)&&(z?(f(E),E=-1):z=!0,qi(x,A-K))):(T.sortIndex=re,n(s,T),y||g||(y=!0,Zi(N))),T},e.unstable_shouldYield=Ue,e.unstable_wrapCallback=function(T){var D=p;return function(){var A=p;p=D;try{return T.apply(this,arguments)}finally{p=A}}}})(ea);Ju.exports=ea;var j0=Ju.exports;/**
 * @license React
...
`)).replace("#include includes",Yd).replace(/\bF\(\s*(.+?)\s*,\s*(.+?)\s*\)/g,xn(e.f).toShader().replace(/\bz\b/g,"$1").replace(/\bc\b/g,"$2")),e.f_prime_z?n=n.replace(/\bF_prime_z\s*\(\s*(.+?)\s*,\s*(.+?)\s*,\s*(.*?)\s*,\s*(.*?)\s*\)/g,xn(e.f_prime_z).toShader().replace(/\bz\b/g,"$1").replace(/\bc\b/g,"$2").replace(/\bz_prime\b/g,"$3").replace(/\bz_1_prime\b/g,"$4")):n=n.replace(/\bF_prime_z\s*\(z,\s*c,\s*(.*?),\s*(.*?)\)/g,"vec2(0)"),e.f_prime_c?n=n.replace(/\bF_prime_c\s*\(z,\s*c,\s*(.*?),\s*(.*?)\)/g,xn(e.f_prime_c).toShader().replace(/z_prime/g,"$1").replace(/z_1_prime/g,"$2")):n=n.replace(/\bF_prime_c\s*\(z,\s*c,\s*(.*?),\s*(.*?)\)/g,"vec2(0)"),e.f_perturb?n=n.replace(/F\(Z,\s*dz,\s*dc\)/g,xn(e.f_perturb).toShader()):n=n.replace(/F\(Z,\s*dz,\s*dc\)/g,"vec2(0)"),window.location.search.includes("debug")&&console.info(n.split(`
`).map((t,r)=>`${r+1}: ${t}`).join(`
